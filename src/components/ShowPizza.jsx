        ...
        <div className='flex items-center w-dvw flex-col h-dvh'>
            ...
            {pizza ? (
                ...
                <div className='bg-[#6b6b6d] bg-opacity-95 border-[3px] border-gray-800 rounded-xl pt-2 pb-8 px-8 flex flex-col'>
                    ...
                    <button className='bg-[#19191a] px-3 py-1 rounded-lg border-2 border-black hover:bg-[#b4b4b5] hover:border-black hover:text-black hover:font-bold mt-6 w-fit self-center' onClick={(() => {navigate('/orders/')})}>Add to order</button>
